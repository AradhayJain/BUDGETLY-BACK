...
import { addExpense, changeGroupBudget, createGroup, deleteGroup, fetchAll } from "../controllers/group.controller.js"
...
router.post('/change-budget',protect,changeGroupBudget);
